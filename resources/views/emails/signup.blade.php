                    ...
                    <tr>
                        <td class="wrapper">
                            <table border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td>
                                        <h3 style="color:#13c482">Welcome abroad!</h3>
                                        <p>Hi {{isset($data['first_name']) ? $data['first_name'] : 'user'}}, Thank you for joining {{ucfirst(config('app.name'))}}.We will try our best to
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tbody>
                                                        <tr>
                                                            <td> <a href="{{url('login')}}" target="_blank">My Account</a> </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
