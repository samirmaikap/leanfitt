<div class="col-lg-3">
    <div class="card">
        <button class="card-header hover-success border-0 btn btn-outline-light" data-toggle="modal" data-target="#modal-note">
            Title
        </button>
        <div class="card-body bt-1 h-350px scrollable">
        ...
        <button class="card-footer bg-success btn btn-success" data-toggle="modal" data-target="#modal-statement">
           Lean thinking statement
        </button>
    </div>
</div>
<div class="col-lg-3">
...
{{--Statement Modal--}}
<div class="modal modal-center fade" id="modal-statement" tabindex="-1">
    <div class="modal-dialog mt-30 ">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Title statement</h5>
                <button type="button" class="close" data-dismiss="modal">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body h-350px scrollable">
                Lorem Ipsum is simply dummy text of the printing and
                typesetting industry. Lorem Ipsum has been the industry's standard
                dummy text ever since the 1500s, when an unknown printer took a galley of type
                and scrambled it to make a type specimen book. It has survived not only
...
{{--Note Modal--}}
<div class="modal modal-center fade" id="modal-note" tabindex="-1">
    <div class="modal-dialog mt-30 ">
        <div class="modal-content">
            <div class="modal-header">
